...
our_colors_df <- data.frame(variable = pesticide_names, 
...
almond_exceed <- exceed_longer %>%
      ...
      slice_max(days, n = 5) %>% # keeping the largest values of the counts by days
...
```{r}
 huc_HUC180400020401_exceed <- exceed_longer %>%
      ...
      slice_max(days, n = 20) %>% # keeping the largest values of the counts by days
